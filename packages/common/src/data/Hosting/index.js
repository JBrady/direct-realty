  ...
  teamMember: [
    {
      ...
      bio:
        "Kathleen is a professional, experienced real estate Broker representing both buyers and sellers in their real estate ventures. Whether you are a first time buyer or an investor, you are unique and will be enthusiastically supported by her team with a client-first philosophy. \
        Having marketed equity sales, short sales and bank owned (REO) properties of various property types, Kathleen is able to maneuver well for optimum results.  Her attention to detail, problem solving skills and commitment to communication allow her to manage this complex and sometimes emotional process seamlessly.  As an full time Realtor, Kathleen understands that staying active in this market is the only way to support that oh-so-current understanding of the market her clients have come to expect. \
        As a member of the San Diego Association of Realtors, Kathleen has full access to legal advice, the latest industry training and is held to a higher standard, a commitment to ethics.  She is licensed with the Bureau of Real Estate as both a Sales Person and a Broker.",
      social_links: [
    ...
    },
    {
      ...
      bio:
        "Joe has real estate in his blood. \
    ...
    },
    {
      ...
      bio:
        "Marcella’s passion to provide her clients with an outstanding experience truly sets her apart.  Marcella is a lifelong San Diego County resident dedicated to a tradition of trust and integrity. \
